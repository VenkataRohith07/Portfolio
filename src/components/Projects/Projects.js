          ...
          <Grid container spacing={4} justifyContent="center">
              <Grid item component={Card} xs={12} md={4} className={styles.project}>
                  <CardContent>
                      ...
                      <div className={styles.iconContainer}>
                       ...
                       <a className={styles.icon} href="https://github.com/VenkataRohith07/Codepen-Clone" target="_blank"><i class="fab fa-github-square fa-lg"></i></a>
                      </div>
                  </CardContent>
              ...
              <Grid item component={Card} xs={12} md={4} className={styles.project}>
                  <CardContent>
                      ...
                      <div className={styles.iconContainer}>
                       <a className={styles.icon} href="https://venkatarohith07.github.io/tic-tac-toe/" target="_blank"><i class="fas fa-link fa-lg"></i></a>
                       <a className={styles.icon} href="https://github.com/VenkataRohith07/tic-tac-toe" target="_blank"><i class="fab fa-github-square fa-lg"></i></a>
                      </div>
                  </CardContent>
